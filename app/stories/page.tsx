                        ...
                        <blockquote className="relative">
                            ...
                            <footer className="mt-6">
                                <div className="flex items-center">
                                    <div className="md:hidden shrink-0 w-32 h-32 rounded-full overflow-hidden">
                                        <Image
                                    ...
                                    <div className="ms-4 md:ms-0">
                                        <div className="text-base font-semibold text-gray-800 dark:text-neutral-200">Nicole Grazioso</div>
                                        <div className="text-xs text-gray-500 dark:text-neutral-400">Director Payments & Risk | Airbnb</div>
                                    </div>
                                </div>
                            </footer>
